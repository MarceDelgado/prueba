...
SECRET_KEY = 'django-insecure-^%fzdv6mn$g!68d5jw9x@s(@7htiy0!a)pf3r(6g+1iqz(^!0k'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates'), os.path.join(BASE_DIR, 'apps/core/templates')], 
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
#URL BASE PARA SERVIR ARCHIVOS ESTATICOS
STATIC_URL = '/static/'

#DIRECTORIOS ADICIONALES DE ARCHIVOS ESTATICOS
